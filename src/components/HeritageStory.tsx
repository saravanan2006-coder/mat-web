  ...
  return (
    <section id="heritage" ref={containerRef} className="relative section-padding bg-white overflow-hidden">
      ...
      <div className="container-wide relative">
        ...
        >
          <span className="text-accent text-sm font-semibold tracking-widest uppercase">{t("heritage.section")}</span>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <div className="text-sm text-text-light">{t("heritage.floating")}</div>
            </motion.div>
          </motion.div>
