  ...
  return (
    <section id="products" className="section-padding bg-cream">
      <div className="container-wide">
        ...
        >
          <span className="text-accent text-sm font-semibold tracking-widest uppercase">Collection</span>
          ...
          <p className="text-text-light text-lg max-w-2xl mx-auto font-light">
            Each mat is a unique piece of art, handcrafted with love and tradition.
          </p>
        </motion.div>
